...
public class UIHud {
    ...
    public UIHud(GameMain game) {
        ...
        scoreTable.add(scoreImage).padLeft(20).padTop(15);
        scoreTable.row();
    ...
    void createLabels() {
        ...
        lifeLabel = new Label("x1", new Label.LabelStyle(font, Color.WHITE));
        scoreLabel = new Label("x2", new Label.LabelStyle(font, Color.WHITE));
    }

    void createImages(){
        coinImage = new Image(new Texture("Collectables/Coin.png"));
        lifeImage = new Image(new Texture("Collectables/Life.png"));
        scoreImage = new Image(new Texture("Buttons/Score.png"));
    }
    void btnAndListener(){
